...
class ClusteringHeuristic:
    def __call__(self, X, p, rng=None):
        """
        Sample-Based p-Median Heuristic with Enhanced Farthest Point Clustering and Voronoi Refining.
        ...
        # Voronoi refining with a limited number of iterations
        for _ in range(min(10, p)):
